...
def test_runtime_guard_fails_closed_on_missing_owner_configuration(monkeypatch) -> None:
...
def test_runtime_guard_allows_a_validated_owner_to_reach_handler(monkeypatch) -> None:
...
def test_runtime_guard_does_not_wrap_non_browser_api_routes(monkeypatch) -> None:
